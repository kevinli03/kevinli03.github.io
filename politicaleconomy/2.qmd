...
1.  **Fundamentals of Econometrics: Using Statstics for Political Science and Political Economy** introduces many of the core statistical concepts and methods used in Political Science and Social Science research. This book mainly covers Linear Regression models and techniques of Causal Inference.
...
Note: This book requires a familiarity with some single variable calculus and probability (specifically, a strong understanding of Bayes' Rule).
