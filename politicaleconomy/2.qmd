...
I assume a basic understanding of statistics, up to correlation. I also assume familiarity with calculus and some linear algebra - although this is only neccesarry if you are interested in how the methods work. If you are just interested in implementing methods and interpreting them, the mathematics is less important, however, I still recommend people to study the mathematics behind econometric techniques, as it often helps us understand the techniques better. To see what mathematics is specifically required, or to refresh on the mathematics needed, consult the **Quantitative Methods** sequence (particularly [the first volume](https://kevinli03.github.io/math/1.pdf)).
...
![](figures/2/4.1.png){fig-align="center" width="70%"}
