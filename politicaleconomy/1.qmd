...
1.  **Quantitative Methods and Analysis** (This Book) introduces many of the core statistical concepts and methods used in Political Science and Social Science research. This book mainly covers Linear Regression models and techniques of Causal Inference.
...
This book on Quantitative Methods focuses on developing the core statistical toolkit of political science and social science research. We start with a brief review of probability and basic statistics. Then, we introduce and rigorously analyse the Linear Regression model, its form, assumptions, extensions, and model selection. Finally, we discuss how we can achieve causal inference through a variety of techniques, such as randomised experiments, selection on observables, instrumental variables, and quasi-experimental methods.

This book comes with a companion manual - [Mathematical Methods for Political Science](https://kevinli03.github.io/politicaleconomy/maths.pdf), which covers some calculus and linear algebra that may be helpful for understanding some of the concepts and math in this book.
