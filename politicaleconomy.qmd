...
While this book goes over the creation of economic models of political situations, it does not go over how we use empirical data to prove/reject our models. The subsequent book, [Introductory Econometrics for Political Economy](https://kevinli03.github.io/econometrics.pdf), covers these methods in detail, including Regression and Causal inference. Those who already have a strong understanding of standard econometric tools can also look at the follow up book, [Advanced Econometrics for Political Economy](https://kevinli03.github.io/advanced.pdf). That book covers more advanced topics in multivariate statistics, latent variables, data science and machine learning approaches, and time series analysis.
