...
-   There are two types of subsets. **Proper subsets** are subsets when the number of elements in $A$ is less than the number of elements in $B$ : $|A| < |B|$. **Imrpoper subsets** are when the number of elements in $A$ is less than or equal to the number of elements in $B$ : $|A| ≤ |B|$
...
$$
Pr(A) = Pr(A|B_1) \times P(B_1) + Pr(A|B_2) \times Pr(B_2) + Pr(A|B_3) \times Pr(B_3)
$$
