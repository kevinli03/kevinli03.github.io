---
title: "Political Econometrics"
subtitle: "Volume I: Introduction to Causal Inference"
...
This book expands on my other book, [An Introduction to Political Economy](https://kevinli03.github.io/politicaleconomy.pdf), which discusses how economic models can be used to study political phenomena. This book adds on to that, explaining how we can test those economic models with empirical data. However, this book can also be used as an independent resource for the study of econometric and statistical techniques for Political Science and other Social Sciences.

Those who already have a strong understanding of standard econometric tools can also look at the follow up book, [Advanced Political Econometrics](https://kevinli03.github.io/advanced.pdf). That book covers more advanced topics in multivariate statistics, latent variables, and time series analysis. For any that are interested in modern data science and machine learning approaches, see [Modern Approaches in Political Econometrics](https://kevinli03.github.io/advanced.pdf).
...
![](figures/econometrics/4.1.png){fig-align="center" width="70%"}
