...
-   **If polls say harris leads by 1.2% (according to 538 aggregator, seems to be most accurate)**

-   If polls say harris leads by 2% (the economist aggregator)

-   If polls say harris leads by 3% (a few polls say this, but unlikely to be true).

<br />

### 2 Best Models (by recent performance)

**Random Forest (5 Variables Bootstrap Sampled) With Height Excluded**:

-   **If harris leads 1.2% in polls: Harris 266.97, [Trump 271.03]{.underline}**
...
**Random Forest (5 Variables Bootstrap Sampled) with Height**:

-   **If harris leads 1.2% in polls: Harris 267.88, [Trump 270.12]{.underline}**
