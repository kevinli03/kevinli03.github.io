...
[A Sampling distribution is the imaginary distribution of estimates, if we repeated sampling and estimation process many, many times]{.underline}.
...
Our estimation so far has produced a $\hat{\beta}_j$ based on the data in our sample. However, remember, the sample is just a fraction of the population - and the true $\hat{\beta}_j$ is unlikely to be exactly the one in our sample, due to sampling variation.
