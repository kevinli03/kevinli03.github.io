...
What is player 1's best strategy? Well, it is to defect, since a payoff of -8 is greater than a pyoff of 1. [So, when player 2 picks defect, player 1 should pick defect]{.underline}.
...
However, an issue with the dominant strategy equilibrium, is that dominant strategies do not appear in most games.
