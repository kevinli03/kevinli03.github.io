---
title: "An Introduction to Political Economy: Econometric Methods"
subtitle: "The second book in the series: An Introduction to Political Economy"
...
This book is the second book in an introduction to the field of Political Economy - the use of economic tools, such as econometrics and game theory, applied to the study of political topics.

This second book in the series focuses on how we can use econometrics to analyse empirical data to prove or reject our hypotheses. This book starts out with the fundamentals of probability and inference. Then, it moves to regression anlaysis. Finally, it moves to methods regarding causal inference.
