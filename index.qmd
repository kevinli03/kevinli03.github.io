...
2.  [Applied Microeconomic Analysis of Politics](https://kevinli03.github.io/politicaleconomy/2.pdf): Applies the microeconomic theory and models discussed in the previous book to current academic topics.

#### **Econometrics for Political Analysis Sequence**
...
1.  [Volume I: Causal Inference](https://kevinli03.github.io/stats/1.pdf): introduces many of the core statistical concepts and methods used in Politics research. This book mainly covers Linear Regression models and techniques of Causal Inference.
2.  [Volume II: Advanced Models](https://kevinli03.github.io/stats/2.pdf): This book mainly covers logit and count regression models, time series models, and latent variable models.
3.  [Volume III: Big Data](https://kevinli03.github.io/politicaleconomy/3.pdf): introduces modern statistical learning techniques that have improved prediction accuracy. The book starts off with prediction and classification methods, then covers model validation, before ending on text mining and quantitative text analysis.
...
1.  [Volume I: Calculus and Probability](https://kevinli03.github.io/math/1.pdf): Essential maths for Political Economics. Covers topics in single variable calculus, probability theory, and statistical theory.
...
3.  [Volume III: Proof and Analysis](https://kevinli03.github.io/math/3.pdf): Covers introductory proofs in mathemtics. Useful, but not essential for the rest of the Political Economics.
