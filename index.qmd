...
-   Quantitative Methods: Pretty much everything in this guide is a pre-requisite for any of the above books. Covers much of single variable calculus and some linear algebra, as well as some basic probability.

-   Further Quantitative Methods: covers more advanced topics in linear algebra and calculus. Not needed for the above books, but definitely helpful.

-   Introductory Proof and Analysis: An introduction into proofs. Can be useful for some of the microeconomic/game theory heavy courses, but not necessary.
