...
I am a student at the London School of Economics, studying for a MSc in Political Science & Political Economy. My interests relate to the use of statistics/econometrics and microeconomic models to study political phenomena.
...
### An Introduction to Political Economics

This is a project that I am working on, that combines everything I have learned in the field of Political Economics in an easy-to-access format.

-   This series on Political Economics includes 3 sequences: Political Economics Sequence, Econometrics Sequence, and the Quantitative Methods Sequence.
-   **NOTE:** This is a work in progress, everything is incomplete.

<br />

##### **An Introduction to Political Economics (Core Sequence)**

1.  [Microeconomic Theory for Political Analysis](https://kevinli03.github.io/politicaleconomy/1.pdf): introduces key concepts microeconomic theory and game theory that form the foundations of economic models of politics.
2.  [Econometrics for Political Analysis](https://kevinli03.github.io/politicaleconomy/2.pdf): introduces many of the core statistical concepts and methods used in Politics research. This book mainly covers Linear Regression models and techniques of Causal Inference.
3.  [Economic Analysis of Politics](https://kevinli03.github.io/politicaleconomy/3.pdf): Applies the microeconomic theory and models, as well as econometrics, to study political phenomena.

##### **Quantitative Methods Sequence**

This sequence is a companion to the Introduction to Political Economics Sequence, adding useful mathematical and statistical techniques.

1.  [Volume I: Calculus and Statistical Theory](https://kevinli03.github.io/math/1.pdf): Essential mathematics for Political Economics. Covers topics in single variable calculus, probability theory, and statistical theory.
...
3.  [Volume III: Advanced Statistical Techniques](https://kevinli03.github.io/math/3.pdf): This book mainly covers logit and count regression models, time series models, and latent variable models. This builds on the core sequence book: Econometrics for Political Analysis.
...
+--------------------------+--------------------------------------------------------------------+
| Concentration:           | Econometrics/Statistics and Game Theory                            |
+--------------------------+--------------------------------------------------------------------+
...
[**Classes/Modules**]{.underline}

Officially Registered Classes:
...
+---------------+----------------------------------------+-----------------------+
| MA102         | Mathematical Proof and Analysis        | Prof. Peter Allen     |
+---------------+----------------------------------------+-----------------------+
| MA108         | Methods in Calculus and Linear Algebra | Dr. Ioannis Kouletsis |
+---------------+----------------------------------------+-----------------------+
| ST304         | Time Series and Forescasting           | Dr. Yining Chen       |
+---------------+----------------------------------------+-----------------------+
